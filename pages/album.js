 ...
 return (
    <div className="bg-[#131722] pb-24 dark:bg-white">
      ...
      <div className="flex justify-start ml-72"> 
        <button className="text-white text-sm mt-20 font-bold dark:text-black">Бүгд/ </button>
        <button className="text-white text-sm mt-20 font-bold dark:text-black">Цомог/ </button>
        <button className="text-white text-sm mt-20 font-bold dark:text-black">Сингл </button>
        <div className="ml-[812px] mt-20 w-[450px] mr-56 rounded-xl h-10 bg-[#0C101B] dark:bg-white border border-[#243049]"> </div>
      </div>
      <div className="mt-8 grid grid-cols-6 gap-y-28 gap-x-14 mr-56 ml-72">
        <div className="bg-[url('https://cdns-images.dzcdn.net/images/cover/54a5fe2fc7496e0ada0d362c249f17a0/264x264.jpg')] bg-cover h-44 w-44 rounded-xl cursor-pointer transition-all duration-500 hover:scale-110">
            <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Toos to Zoos </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Ginjin</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> ATM </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Ginjin</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black">  Хүний хүн </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Ginjin</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> BABA</div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Ginjin</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Бороо </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Ginjin</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> HOT BOY</div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Ginjin</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Most HATED </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Vandebo</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black">  Баярлалаа </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Vandebo</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Munkhud 21 </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Vandebon</span>
            </button>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> IN YOUR DREAM </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Vandebo</span>
            </button>
        </div> 
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> дөнгөн данган </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Vandebo</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> 3-тун </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Vandebo</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Нэг өдөр </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Thunderz</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Хатуу </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Thunderz</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Нисээрэй </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Thunderz</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Street </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Thunderz</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> чи өөрөө </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Thunderz</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Ноён эмэгтэй </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">Thunderz</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Халуун маруужин </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">NENE</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Okay </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">NENE</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Afterland </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">NENE</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> 90on </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">NENE</span>
            </button>
        </div>
        ...
        <button className="mt-44 ">
                <div className="text-gray-300 font-bold text-sm flex items-start dark:text-black"> Zuruhgui </div>
                <span className="text-gray-300 flex items-start text-xs dark:text-black ">NENE</span>
            </button>
        </div>
